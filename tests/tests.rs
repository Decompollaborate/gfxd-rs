...
fn test_blockrgba16() {
    static INPUT: [u8; 0x90] = [
        ...
        0xFD, 0x10, 0x00, 0x00, 0x07, 0x00, 0x80, 0x00, //
        0xF5, 0x10, 0x00, 0x00, 0x07, 0x09, 0x02, 0x60, //
        0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //
        0xF3, 0x00, 0x00, 0x00, 0x07, 0x3F, 0xF0, 0x80, //
        0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //
        0xF5, 0x10, 0x20, 0x00, 0x00, 0x09, 0x02, 0x60, //
        0xF2, 0x00, 0x00, 0x00, 0x00, 0x0F, 0xC0, 0x3C, //
        0xFC, 0x12, 0x7E, 0x03, 0xFF, 0xFF, 0xF3, 0xF8, //
        0xE2, 0x00, 0x00, 0x1C, 0xC8, 0x11, 0x30, 0x78, //
        0xD9, 0xF1, 0xFB, 0xFF, 0x00, 0x00, 0x00, 0x00, //
        0xD9, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x00, 0x00, //
        0xFA, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, //
        0x01, 0x00, 0x30, 0x06, 0x07, 0x00, 0x00, 0x00, //
        0x05, 0x00, 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, //
        0xDF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //
    ];
    static OUTPUT: &str = "\
{
    ...
    gsDPLoadTextureBlock(D_07008000, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, 6, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPSetGeometryMode(G_FOG),
    gsDPSetPrimColor(0, 0, 0xFF, 0xFF, 0xFF, 0xFF),
    gsSPVertex(D_07000000, 3, 0),
...
";
    ...
    let expected_tracker = Tracker {
        timg: HashMap::from_iter(
            [(
                Address(0x07008000),
                (TexFmt::Rgba, TexSiz::Siz16b, 64, 16, 0),
            )]
            .to_vec(),
        ),
        vtx: HashMap::from_iter([(Address(0x07000000), (3,))].to_vec()),
        ..Tracker::default()
    };
    assert_eq!(expected_tracker, tracker);
}
